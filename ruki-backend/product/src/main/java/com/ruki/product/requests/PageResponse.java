...
// AQUÍ PONEMOS EL FORMATO DE COMO QUEREMOS ENVIAR LOS PRODUCTOS, EN 
// ESTE CASO LO QUE QUEREMOS ENVIAR SON PRODUCTOS CON UN ÍNDICE Y CON 
...
public class PageResponse<T> {
    ...
    private List<T> content;       // LISTA DE PRODUCTOS
