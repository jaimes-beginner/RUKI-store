...
// AQUÍ PONEMOS EL FORMATO DE COMO QUEREMOS ENVIAR LOS PEDIDOS, EN 
// ESTE CASO LO QUE QUEREMOS ENVIAR SON PEDIDOS CON UN ÍNDICE Y CON 
...
public class PageResponse<T> {
    ...
    private List<T> content;       // LISTA DE PEDIDOS
