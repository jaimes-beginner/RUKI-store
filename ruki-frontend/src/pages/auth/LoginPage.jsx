                ...
                >
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        <div className="ios-input-group mb-3">
                            ...
                            <AnimatePresence>
                                {errores.correo && <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="input-error-text">{errores.correo}</motion.div>}
                            </AnimatePresence>
                        </div>
                        ...
                        <div className="ios-input-group mb-4">
                            ...
                            <AnimatePresence>
                                {errores.password && <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="input-error-text">{errores.password}</motion.div>}
                            </AnimatePresence>
                        </div>
                        ...
                        <div className="d-grid gap-3">
                            ...
                            <motion.button whileTap={{ scale: 0.96 }} type="button" onClick={() => navigate("/")} className="ios-btn-back">
                                Volver al inicio
                            </motion.button>
                        </div>
                    </form>
                    ...
                    <div className="login-footer d-flex flex-column align-items-center gap-2 mt-4 pt-3">
                        <small>¿No tienes una cuenta? <Link to="/crear-usuario" className="login-link fw-bold text-decoration-none">Regístrate ahora</Link></small>
                        <small>¿Olvidaste tu contraseña? <Link to="/forgot-password" className="login-link fw-bold text-decoration-none">Recupérala aquí</Link></small>
                    </div>
                </motion.div>
            </div>
        </div>
