...
export function MisPedidos() {
    ...
    return (
        <div className="orders-main-wrapper">
            ...
            {/* LUCES DE FONDO (Cargan de inmediato) */}
            ...
            <div className="orders-container position-relative z-1">
                ...
                {/* 💡 LÓGICA CONDICIONAL DE CARGA/AUTH INTEGRADA EN EL FLUJO */}
                {!isAuthenticated ? (
                                                        ...
                                                        >
                                                            <div className="order-body">
                                                                ...
                                                                <div className="order-shipping-info mb-4">
                                                                    ...
                                                                    <div className="p-3 rounded-3 border-dark small fw-medium" style={{ backgroundColor: 'rgba(255,255,255,0.03)', color: '#e5e5ea' }}>
                                                                        {direccionReal}
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div className="order-payment-summary mt-4">
                                                                    ...
                                                                    <div className="p-3 rounded-3 border small border-dark" style={{ backgroundColor: 'rgba(0,0,0,0.3)', borderColor: 'rgba(255,255,255,0.08)' }}>
                                                                        <div className="d-flex justify-content-between mb-2 text-secondary fw-medium">
                                                                            ...
                                                                            <span className="text-white opacity-75">${Number(pedido.subTotal || 0).toLocaleString('es-CL')}</span>
                                                                        </div>
                                                                        <div className="d-flex justify-content-between mb-2 text-secondary fw-medium">
                                                                            <span>IVA (19%)</span>
                                                                            <span className="text-white opacity-75">${Number(pedido.taxAmount || 0).toLocaleString('es-CL')}</span>
                                                                        </div>
