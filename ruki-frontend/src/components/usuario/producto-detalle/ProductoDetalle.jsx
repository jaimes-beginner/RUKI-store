...
export function ProductoDetalle() {
    ...
    return (
        <main className="prod-detail-wrapper pb-5">
            ...
            {/* LAS LUCES DE FONDO DEL DETALLE (Cargan de inmediato) */}
            ...
            <div className="container py-3 py-md-5 mt-md-3 position-relative z-2">
                
                {/* BOTÓN VOLVER (Carga de inmediato, permite al usuario arrepentirse si el internet está lento) */}
                ...
                {loading ? (
                    <div className="d-flex flex-column justify-content-center align-items-center" style={{ minHeight: '50vh' }}>
                        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="spin-animation mb-3" style={{color: '#86868b'}}>
