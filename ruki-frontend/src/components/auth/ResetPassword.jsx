...
export function ResetPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!token) {
            setError("No se detectó un token de seguridad válido.");
            return;
        }

        if (!REGEX_CONTRASENA.test(passwords.newPassword)) {
            setError("La contraseña no cumple el formato de seguridad.");
            return;
        }
