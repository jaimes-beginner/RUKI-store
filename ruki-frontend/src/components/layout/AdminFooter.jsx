      ...
      <div className="container-fluid px-4">
        <div className="row justify-content-between text-center text-md-start">
          ...
          <div className="col-md-3 mb-4 ms-auto text-center text-md-end">
            ...
            <ul className="list-unstyled d-flex flex-column gap-2 mt-3">
              ...
              <li><Link to="/admin/inventario" className="admin-footer-link">Gestión de Productos</Link></li>
              <li><Link to="#" className="admin-footer-link disabled-link">Blog (Próximamente)</Link></li>
              <li><Link to="#" className="admin-footer-link disabled-link">Soporte Técnico</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 text-center text-md-end mt-3 mt-md-0 d-flex justify-content-center justify-content-md-end gap-4">
            ...
            <Link to="#" className="admin-footer-bottom-link disabled-link">Términos de Uso</Link>
          </div>
        </div>
      </div>
    </footer>
